...
THEME_PRESETS: List[ThemePreset] = [
    ThemePreset(
        name="black",
        keywords=[
            "чёрн", "черн", "чёрный фон", "черный фон", "black", "чёрное",
            "максимально тёмн", "очень тёмн", "очень темн",
        ],
        palette={
            "gradient_start": "0A0A0C",   # почти абсолютно чёрный
            "gradient_end": "141417",     # чуть-чуть светлее, едва заметно
            "card_bg": "1C1C20",          # тёмная карточка
            "kpi_bg": "242428",           # KPI чуть светлее
            "text_dark": "FFFFFF",        # белый текст
            "text_muted": "A0A0A8",       # серый приглушённый
            "accent": "6C9EFF",           # синий акцент
            "badge": "FF6B6B",            # коралл
        },
    ),
    ThemePreset(
        name="dark",
        keywords=[
            "тёмн", "темн", "dark", "ночн", "тёмное оформление",
            "dark mode", "тёмная тема", "темная тема", "графит",
        ],
        palette={
            "gradient_start": "121420",   # очень тёмный сине-серый
            "gradient_end": "1C2030",     # тёмно-синий графит (мягкий градиент)
            "card_bg": "1F2230",          # тёмная карточка
            "kpi_bg": "282C3C",           # чуть светлее для KPI
